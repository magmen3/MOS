...
NPC.MeleeAttackAnimations = {"kickdoorbaton", "pushplayer"}
NPC.MeleeWeaponAnimations = {"kickdoorbaton", "pushplayer"} -- Animations to use when attacking with a melee weapon
